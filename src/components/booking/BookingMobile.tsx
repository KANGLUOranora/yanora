              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={4}
                    className="w-full px-4 py-3 bg-white border rounded-none text-sm tracking-wide transition focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent resize-none"
                    style={{borderColor: '#E5E7EB', color: '#1F1F1F'}}
