...
const zhTranslations = {
  ...
  privacyPolicy: {
    ...
    infoCollection: {
      title: '信息收集',
      intro: '我们收集您在使用我们服务时提供的信息，包括但不限于：',
      items: [
        '个人身份信息（姓名、电子邮箱、电话号码）',
        '账户信息（用户名、密码）',
        '预约信息（服务类型、预约时间、偏好设置）',
...
const enTranslations = {
  ...
  privacyPolicy: {
    ...
    infoCollection: {
      ...
      intro: 'We collect information you provide when using our services, including but not limited to:',
      items: [
        'Personal identification information (name, email, phone number)',
        'Account information (username, password)',
        'Booking information (service type, appointment time, preferences)',
        'Payment information (transaction records, payment methods)',
    ...
    infoUsage: {
      ...
      items: [
        ...
        'Analyze usage trends to optimize user experience',
        'Prevent fraud and ensure platform security',
      ],
    },
    infoProtection: {
      title: 'Information Protection',
      intro: 'We take reasonable technical and organizational measures to protect your personal information:',
      items: [
        'Use encryption technology to protect data transmission',
        'Implement strict access controls and authentication',
        'Conduct regular security audits and vulnerability scans',
        'Employees sign confidentiality agreements and receive privacy training',
        'Restrict access to personal information to authorized personnel only',
      ],
    },
    yourRights: {
      title: 'Your Rights',
      intro: 'Under applicable privacy laws, you have the following rights:',
      items: [
        'Access: View your personal information we hold',
        'Correction: Update or correct inaccurate information',
        'Deletion: Request deletion of your personal information',
        'Restriction: Restrict our processing of your information',
        'Objection: Object to our use of your information',
        'Portability: Receive your data in a structured format',
      ],
    },
    contact: {
      title: 'Contact Us',
      intro: 'If you have any questions about this privacy policy or need to exercise your rights, please contact us:',
      email: 'Email',
      phone: 'Phone',
    },
